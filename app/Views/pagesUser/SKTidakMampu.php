    ...
    <main>
        <div class="big-wrapperr light">
            ...
            <div class="form">
                ...
                <form action="/SKTidakMampu/save" method="POST" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <div class="user-details">
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" id="tempat_Lahir" name="tempat_Lahir" class="form-control <?= ($validation->hasError('tempat_Lahir')) ? 'is-invalid' : ''; ?>" value="<?= old('tempat_Lahir'); ?>">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="group-list">
                            <div class="form-check">
                                <input type="radio" name="jenis_kelamin" value="Laki-laki" class="form-check-input" id="laki" required>
                    ...
                    <div class="input-box" style="margin-bottom: 15px;">
                        <span class="details" style="display: block; font-weight: 500; margin-bottom: 5px; padding-top: 20px;">Rincian
                            Pembiayaan Biaya Pendidikan</span>
                        <div class="custom-file" onchange="previewLabel5()">
                            <input type="file" class="custom-file-input <?= ($validation->hasError('rincian_biaya')) ? 'is-invalid' : ''; ?>" id="rincian_biaya" name="rincian_biaya">
                            <div class="invalid-feedback">
                                <?= $validation->getError('rincian_biaya'); ?>
                            </div>
                            <label class="custom-file-label rincian_biaya" for="rincian_biaya">Pilih File...</label>
                        </div>
                    </div>
