        ...
        <div class="big-wrapperr light">
            ...
            <div class="form">
                ...
                <form action="#">
                    ...
                    <div class="input-box" style="margin-bottom: 15px;">
                        <span class="details" style="display: block; font-weight: 500; margin-bottom: 5px; padding-top: 20px;">Rincian Pembiayaan Biaya Pendidikan</span>
                        <div class="custom-file">
                            <input type="file" class="rincian_biaya" id="rincian_biaya">
                            <label class="custom-file-label" for="rincian_biaya">Choose file</label>
                        </div>
                    </div>
