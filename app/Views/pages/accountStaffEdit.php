                ...
                <div class="col-md-6">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Ubah Akun Staff Kecamatan</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="/AdminStaff/update/<?= $admin['id_account']; ?>" method="post">
                            <?= csrf_field(); ?>
                            <div class="card-body">
                            ...
                            <div class="form-group text-end mr-3">
                                ...
                                <a href="/AdminStaff" type="button" class="btn btn-secondary ml-2">Back</a>
                            </div>
                            <!-- /.card-body -->
                        </form>
                    </div>
