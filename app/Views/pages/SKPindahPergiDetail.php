                ...
                <table id="tableAdmin" class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Jumlah Pindah</th>
                            <th scope="col">Surat Pengantar RT/RW</th>
                            <th scope="col">Foto KTP</th>
                            <th scope="col">Foto KK</th>
                            <th scope="col">Dokumen Izin Tempat Tinggal</th>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($detailSurat as $a) : ?>
                            <tr>
                                ...
                                <td><img class="profile-user-img img-fluid" src="/file/<?= $a['ijin_tinggal']; ?>" style="width: 100%;"></td>
