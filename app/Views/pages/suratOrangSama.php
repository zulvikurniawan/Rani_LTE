...
<div class="content-wrapper container-backgorund" style="margin-bottom: 50px;">
    ...
    <section class="content">
        <div class="form">
            ...
            <a href="/Pengajuan/cetakSurat/<?= $pengajuanDetail['id_SKOrangSama']; ?>" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
            ...
            <?php foreach ($detailSurat as $a) : ?>
                ...
                <div class="penutup">
                    <p>Nama tersebut diatas adalah benar lahir pada tanggal <?= $a['tanggal_Lahir']; ?> sesuai yang tertera pada Kartu Keluarga sedangkan yang tertera pada Kutipan Akta Nikah lahir pada tanggal <?= $a['tanggal_Lahir']; ?> perlu dijelaskan bahwa diantara kedua tanggal lahir keduanya adalah benar tanggal lahir orang yang sama.</p>
                    <p>
