...
class Masyarakat extends BaseController
{
    ...
    {
        $data = [
            'title' => 'Report | KELURAHAN BUARAN INDAH',
    ...
    {
        $data = [
            'title' => 'Detail masyarakat | KELURAHAN BUARAN INDAH',
            'SidebarMenuOpen' => 'masyarakat',
            'SidebarMenuActive' => 'masyarakat',
    ...
    {
        $data = [
            'title' => 'Add masyarakat | KELURAHAN BUARAN INDAH',
            'SidebarMenuOpen' => 'masyarakat',
            'SidebarMenuActive' => 'masyarakat',
            'validation' => \config\Services::validation()
        ];
    ...
    public function approval()
    {
        $status = 'pending';
        $data = [
            'title' => 'Masyarakat | KELURAHAN BUARAN INDAH',
            'SidebarMenuOpen' => 'masyarakat',
            'SidebarMenuActive' => 'approval',
    ...
    public function edit($id_masyarakat)
    {
        $data = [
            ...
            'title' => 'Edit masyarakat | KELURAHAN BUARAN INDAH',
            'SidebarMenuOpen' => 'masyarakat',
            'SidebarMenuActive' => 'masyarakat',
            'validation' => \config\Services::validation(),
            'masyarakat' => $this->MasyarakatModel->getMasyarakat($id_masyarakat)
